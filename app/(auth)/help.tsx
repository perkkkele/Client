...
const FAQ_ITEMS: FAQItem[] = [
    {
        ...
        answer: "Por favor revisa tu carpeta de Spam o Correo no deseado. Si no aparece, puedes solicitar un nuevo código en 60 segundos.",
    },
    {
        question: "La contraseña no es válida",
        answer: "Tu contraseña debe tener entre 8 y 20 caracteres, incluir al menos una letra mayúscula, un número y un símbolo especial.",
    },
    {
        question: "¿Cómo funciona el avatar digital?",
        answer: "Tu avatar se genera automáticamente basado en tus preferencias iniciales. Podrás personalizarlo completamente después del registro.",
    },
];
...
const GUIDE_ITEMS: GuideItem[] = [
    {
        icon: "article",
        title: "Guía rápida de registro",
        duration: "2 min de lectura",
    },
    {
        icon: "play-circle",
        title: "Video tutorial: Tu primer avatar",
        duration: "1:30 min",
    },
];
